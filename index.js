...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5511932300710@s.whatsapp.net"] // replace this with your number
...
case 'textodeneve':
				...
				case 'wait':
					...
					break
                                					case 'dono':
if (args.length < 1) return reply('TrashфDkofcꪶ Número do meu dono😎🤙:WA.me/5511932300710\n😎🤙')
                                        break
case 'porno':
